...
BASE="ffmpeg -y -hide_banner -loglevel error -i \"$INPUT\" -strict -1 -pix_fmt yuv420p10le -f yuv4mpegpipe - | rav1e -y - --threads $THREADS --tile-cols 2 --tile-rows 1 $QUALITY_SETTINGS $FLAG"
